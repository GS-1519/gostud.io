...
const SpeakerHero = () => {
  return (
    <div className="relative overflow-hidden pt-20 sm:pt-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center py-4 sm:py-6">
            ...
            <div className="max-w-[733px] text-center lg:text-left px-2 sm:px-0">
              <h1 className="text-[24px] sm:text-[28px] md:text-[36px] lg:text-[40px] font-bold leading-tight flex flex-col gap-0.5 sm:gap-1">
                <div className="flex flex-wrap justify-center lg:justify-start items-center">
                  <span className="bg-gradient-to-r from-[#8371FF] via-[#A077FE] to-[#01C7E4] bg-clip-text text-transparent whitespace-nowrap">
                    Capture the Real You Events &
                  </span>
                </div>
                
                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="bg-[#8371FF] bg-clip-text text-transparent">Ted Talks.</span>
                  <span className="text-[#161C2D]">That Spark</span>
                </div>

                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="text-[#161C2D]">engagement with audience</span>
                </div>
              </h1>

              <p className="mt-4 sm:mt-6 text-base sm:text-lg text-[#4B5563] max-w-[600px] mx-auto lg:mx-0">
                Stand out on stage with AI portraits designed to convey confidence, authority, and connection.
              </p>
              ...
              <div className="mt-6 sm:mt-8 grid grid-cols-2 gap-2 sm:gap-3 max-w-[600px] mx-auto lg:mx-0">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[#4B5563] text-xs sm:text-sm whitespace-nowrap">Guaranteed results</span>
                </div>
              </div>
          ...
          <div className="relative h-[250px] sm:h-[350px] md:h-[450px] lg:h-[600px] w-full mt-6 lg:mt-0 lg:translate-x-12">
            <Image
              src="/speaker.png"
