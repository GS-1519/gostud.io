...
const SpeakerHero = () => {
  ...
  const handleGetStarted = () => {
    localStorage.setItem('intendedPack', JSON.stringify({
      type: 'speaker',
      path: '/headshot-packs/ted-speaker-headshot',
      redirect: true
    }));
    router.push('/login');
  };
    ...
    <div className="relative overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-4 lg:gap-6 items-center py-2 sm:py-4">
            ...
            <div className="max-w-[733px] text-center lg:text-left">
              <h1 className="text-[24px] sm:text-[28px] md:text-[36px] lg:text-[40px] font-bold leading-tight flex flex-col gap-1">
                <div className="flex flex-wrap justify-center lg:justify-start items-center">
                  <span className="text-[#01C7E4]">
                    {t('heroPages.speaker.title.part1')}
                  </span>
                </div>
                
                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="text-[#8371FF]">{t('heroPages.speaker.title.part2')}</span>
                </div>

                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="text-[#161C2D]">{t('heroPages.speaker.title.part3')}</span>
                </div>

                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="text-[#161C2D]">{t('heroPages.speaker.title.part4')}</span>
                </div>
              </h1>

              <p className="mt-2 sm:mt-4 text-base sm:text-lg text-[#4B5563] max-w-[600px] mx-auto lg:mx-0">
                {t('heroPages.speaker.description')}
              </p>
              ...
              <div className="mt-4 sm:mt-6 grid grid-cols-2 gap-2 max-w-[600px] mx-auto lg:mx-0">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[#4B5563] text-xs sm:text-sm whitespace-nowrap">{t('heroFeatures.guarantee')}</span>
                </div>
              </div>
          ...
          <div className="relative h-[200px] sm:h-[300px] md:h-[400px] lg:h-[500px] w-full mt-2 lg:mt-0 lg:translate-x-12">
            <Image
              src="/speaker.png"
              alt="Speaker headshots"
              fill
