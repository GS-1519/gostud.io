...
const BirthdayHero = () => {
  return (
    <div className="relative overflow-hidden pt-16 lg:pt-8 sm:pt-15">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center py-6 sm:py-8 md:py-12 lg:py-8">
          ...
          {/* Right image section - Updated styling */}
          <div className="relative h-[250px] sm:h-[350px] md:h-[450px] lg:h-[600px] w-full mt-6 lg:mt-0">
            <Image
              ...
              sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 30vw" // Adjusted to make the image slightly smaller
              priority
            />
          </div>
        </div>
