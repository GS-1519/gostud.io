  ...
  return (
    <div className="relative overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center py-6 sm:py-8 md:py-12">
          <div className="flex flex-col items-center lg:items-start">
            {/* Main content */}
            <div className="max-w-[733px] text-center lg:text-left px-2 sm:px-0">
              <h1 className="text-[28px] sm:text-[32px] md:text-[36px] lg:text-[40px] font-bold leading-tight flex flex-col gap-2 sm:gap-3">
                ...
                <div className="flex justify-center lg:justify-start">
                  <span className="text-[#161C2D] break-words sm:whitespace-nowrap">
                    with Generative Artistic Filters
                  </span>
                </div>
              </h1>
              ...
              <div className="mt-6 sm:mt-8 grid grid-cols-2 gap-3 sm:gap-4 max-w-[600px] mx-auto lg:mx-0">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="text-[#4B5563] text-xs sm:text-sm">Done in less than 1 hour</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="rounded-full bg-[#F3E8FF] p-1.5 sm:p-2 flex-shrink-0">
          ...
          <div className="relative h-[250px] sm:h-[350px] md:h-[450px] lg:h-[600px] w-full mt-6 lg:mt-0">
            <Image
              src="/art.png"
              alt="Artistic headshots showcase"
              fill
