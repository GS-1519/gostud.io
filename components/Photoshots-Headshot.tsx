...
const GlamourHeadshotHero = () => {
  ...
  const images = {
    woman: [
      { src: '/Packs/Photoshots-photos/Women/women1.jpg', alt: 'Professional photoshoot woman portrait' },
      { src: '/Packs/Photoshots-photos/Women/women2.jpg', alt: 'Studio female headshot' },
      { src: '/Packs/Photoshots-photos/Women/women3.jpg', alt: 'Contemporary woman portrait' },
      { src: '/Packs/Photoshots-photos/Women/women4.jpg', alt: 'Professional female photo' },
      { src: '/Packs/Photoshots-photos/Women/women5.jpg', alt: 'Modern woman portrait' },
      { src: '/Packs/Photoshots-photos/Women/women6.jpg', alt: 'Studio style female headshot' },
      { src: '/Packs/Photoshots-photos/Women/women7.jpg', alt: 'Professional woman portrait' },
      { src: '/Packs/Photoshots-photos/Women/women8.jpg', alt: 'Contemporary female photo' },
      { src: '/Packs/Photoshots-photos/Women/women9.jpg', alt: 'Studio female portrait' },
      { src: '/Packs/Photoshots-photos/Women/women10.jpg', alt: 'Professional female photo' },
    ],
    man: [
      { src: '/Packs/Photoshots-photos/Man/man1.jpg', alt: 'Professional photoshoot man portrait' },
      { src: '/Packs/Photoshots-photos/Man/man2.jpg', alt: 'Studio male headshot' },
      { src: '/Packs/Photoshots-photos/Man/man3.jpg', alt: 'Contemporary man portrait' },
      { src: '/Packs/Photoshots-photos/Man/man4.jpg', alt: 'Professional male photo' },
      { src: '/Packs/Photoshots-photos/Man/man5.jpg', alt: 'Modern man portrait' },
      { src: '/Packs/Photoshots-photos/Man/man6.jpg', alt: 'Studio style male headshot' },
      { src: '/Packs/Photoshots-photos/Man/man7.jpg', alt: 'Professional man portrait' },
      { src: '/Packs/Photoshots-photos/Man/man8.jpg', alt: 'Contemporary male photo' },
    ]
  };
