      ...
      <div className="text-center space-y-8">
        <div className="space-y-4">
          <h1 className="text-4xl sm:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-violet-500 to-cyan-400 leading-tight tracking-tight">
            Enchanted Mythical Portrait Collection
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Transform your photos into magical portraits that capture the essence of mythical realms and legendary tales
          </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-4 pt-4">
          {activeCategory === 'all' ? (
            ...
            <Link href="/login">
              <button 
                className="group flex items-center gap-2 px-10 py-3 rounded-full transition-all duration-300 transform hover:scale-105 text-white bg-gradient-to-r from-purple-500 via-violet-500 to-cyan-400 hover:opacity-90"
              >
                Generate More
...
export default MythicalHeadshotHero; 