      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center py-8 sm:py-12">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="max-w-[733.27px] text-center lg:text-left">
              <h1 className="text-[48px] font-bold leading-tight">
                <div className="bg-gradient-to-r from-[#8371FF] via-[#A077FE] to-[#01C7E4] bg-clip-text text-transparent flex flex-col">
                  <div className="whitespace-nowrap">Timeless Elegance AI-</div>
                  <div className="whitespace-nowrap">Generated Glamour Shots</div>
                </div>
              </h1>
