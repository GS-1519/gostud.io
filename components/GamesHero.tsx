        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center py-8 sm:py-12">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="max-w-[733px] text-center lg:text-left">
              <h1 className="text-[28px] sm:text-[32px] md:text-[36px] lg:text-[40px] font-bold">
                <div className="text-[#161C2D]">
                  Step Into Westeros
                  <span className="ml-2 bg-[#01C7E4] bg-clip-text text-transparent whitespace-normal">
                    AI
                  </span>
                </div>
                <div>
                  <span className="bg-gradient-to-r from-[#8371FF] via-[#A077FE] to-[#01C7E4] bg-clip-text text-transparent whitespace-nowrap">
                    Headshots Inspired by Game of
                  </span>
                </div>
                <div>
                  <span className="bg-[#8371FF] bg-clip-text text-transparent">
                    Thrones
                  </span>
                </div>
              </h1>
              ...
              Bring the intrigue, drama, and nobility of Westeros to life with AI headshots inspired by the epic style of Game of Thrones.              </p>
              {/* Features grid */}
