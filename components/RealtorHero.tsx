            ...
            <div className="max-w-[733px] text-center lg:text-left px-2 sm:px-0">
              <h1 className="text-[24px] sm:text-[28px] md:text-[36px] lg:text-[40px] font-bold leading-tight flex flex-col gap-2 sm:gap-3">
                <div className="flex flex-wrap justify-center lg:justify-start items-center gap-x-1">
                  <span className="text-[#111827] whitespace-normal sm:whitespace-nowrap">Close more deal with</span>
                  <span className="text-[#01C7E4] whitespace-normal sm:whitespace-nowrap">studio-</span>
                </div>
                
                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="text-[#8371FF]">quality</span>
                  <span>,</span>
                  <span className="text-[#8371FF] ml-1">realtor &</span>
                  <span className="text-[#01C7E4] ml-1">real estate</span>
                </div>

                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="text-[#8371FF]">agent</span>
                  <span className="text-[#111827] ml-1">AI Headshots</span>
                </div>
              </h1>
