  ...
  return (
    <div className="relative overflow-visible">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-32 items-center py-8 sm:py-12">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="max-w-[733px] text-center lg:text-left">
              <h1 className="text-[28px] sm:text-[32px] md:text-[36px] lg:text-[41px] font-bold">
                {/* First row - all in one line with nowrap */}
                <div className="whitespace-nowrap">
                  Close more deal with 
                  <span className="text-[#01C7E4]"> studio-</span>
                </div>
                
                {/* Second row */}
                <div className="mt-2">
                  <span className="text-[#8371FF]">quality</span>
                  <span>, </span>
                  <span className="text-[#8371FF]">realtor & </span>
                  <span className="text-[#01C7E4]">real estate</span>
                </div>

                {/* Third row */}
                <div className="mt-2">
                  <span className="text-[#8371FF]">agent</span>
                  <span> AI Headshots</span>
                </div>
              </h1>

              <p className="mt-6 text-[18px] text-[#4B5563] max-w-[600px]">
                Get more clients and increase your social presence with GoStudio.ai at home.
              </p>
          ...
          <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[700px] w-full mt-8 lg:mt-0">
            <div className="absolute right-[-180px] w-[150%] h-full">
              <div className="relative w-full h-full">
                <Image
                  src="/real.png"
                  alt="Before and after headshots comparison"
                  fill
