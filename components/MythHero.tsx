        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-center py-8 sm:py-12">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="max-w-[733px] text-center lg:text-left">
              <h1 className="text-[28px] sm:text-[32px] md:text-[36px] lg:text-[46px] font-bold leading-tight">
                <span className="text-[#111827] whitespace-nowrap">
                  Fantasy Unleashed AI
                </span>
                {' '}
                ...
                {' '}
                <span>
                  <span className="bg-[linear-gradient(90deg,_#8371FF_-39.48%,_#A077FE_32.07%,_#01C7E4_100%)] bg-clip-text text-transparent">
                    Mythical
                  </span>
                  {' '}
