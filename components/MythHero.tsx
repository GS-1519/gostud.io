            ...
            <div className="max-w-[733px] text-center lg:text-left px-2 sm:px-0">
              <h1 className="text-[24px] sm:text-[28px] md:text-[36px] lg:text-[40px] font-bold leading-tight flex flex-col gap-0.5 sm:gap-1">
                <div className="flex flex-wrap justify-center lg:justify-start items-center gap-x-1">
                  <span className="text-[#111827]">Fantasy Unleashed AI</span>
                </div>
                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="text-[#111827]">Headshots of</span>
                </div>
                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="bg-[linear-gradient(90deg,_#8371FF_-39.48%,_#A077FE_32.07%,_#01C7E4_100%)] bg-clip-text text-transparent">Mythical</span>
                  <span className="text-[#8371FF] ml-1">Creatures</span>
                </div>
              </h1>

              <p className="mt-4 sm:mt-6 text-base sm:text-lg text-[#4B5563] max-w-[600px] mx-auto lg:mx-0">
                Step into the spotlight with AI-generated headshots that radiate sophistication, elegance, and luxury, just like the stars.
              </p>
