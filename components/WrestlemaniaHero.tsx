          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="max-w-[733px] text-center lg:text-left">
              <h1 className="text-[28px] sm:text-[32px] md:text-[36px] lg:text-[40px] font-bold leading-tight flex flex-col gap-2">
                ...
                {/* Second row */}
                <div>
                  <span className="text-[#161C2D] whitespace-nowrap">Headshots Inspired by </span>
                </div>
                <div>
                  <span className="text-[#161C2D] whitespace-nowrap"> Wrestlemania</span>
                </div>
                
              </h1>

              <p className="mt-6 text-[18px] text-[#4B5563]">
              Capture the fierce energy and power of Wrestlemania with AI portraits that showcase your bold, competitive spirit.              </p>
              {/* Features grid */}
...
export default WrestlemaniaHero
