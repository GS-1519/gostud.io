...
const LinkedlnHero = () => {
  ...
  const handleGetStarted = () => {
    ...
    localStorage.setItem('intendedPack', JSON.stringify({
      type: 'linkedin',
      path: '/headshot-packs/linkedin-headshot',
      redirect: true
    }));
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center py-4 sm:py-6">
          <div className="flex flex-col items-center lg:items-start">
            {/* Main content - Removed notification banner */}
            <div className="max-w-[733px] text-center lg:text-left px-2 sm:px-0">
              <h1 className="text-[24px] sm:text-[28px] md:text-[36px] lg:text-[40px] font-bold leading-tight flex flex-col gap-0.5 sm:gap-1">
                <div className="flex flex-wrap justify-center lg:justify-start items-center gap-x-1">
                  <span className="text-[#161C2D]">Land on jobs easily with our</span>
                </div>
                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="bg-[#8371FF] bg-clip-text text-transparent">LinkedIn</span>
                  <span className="text-[#161C2D]"> AI Headshots</span>
                </div>
              </h1>
              ...
              <div className="mt-6 sm:mt-8 grid grid-cols-2 gap-2 sm:gap-3 max-w-[600px] mx-auto lg:mx-0">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[#4B5563] text-xs sm:text-sm whitespace-nowrap">Done in less than 1 hour</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <div className="rounded-full  p-1 sm:p-1.5 flex-shrink-0">
          ...
          {/* Right side image - Updated styling */}
