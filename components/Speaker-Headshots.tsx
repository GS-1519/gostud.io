        ...
        <div className="flex flex-col items-center gap-4 pt-4">
          {activeCategory === 'all' ? (
            <button
              ...
              className="group flex items-center gap-2 px-8 py-3 bg-green-500 text-white rounded-full hover:bg-green-600 transition-all duration-300 transform hover:scale-105"
            >
              {showAll ? (
                <>
                  Show Less
            ...
            <Link href="/login">
              <button 
                className="group flex items-center gap-2 px-10 py-3 rounded-full transition-all duration-300 transform hover:scale-105 text-white bg-gradient-to-r from-green-600 via-teal-500 to-blue-400 hover:opacity-90"
              >
                Generate More
...
export default SpeakerHeadshotHero; 