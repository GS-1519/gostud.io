        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center py-8 sm:py-12">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="max-w-[733px] text-center lg:text-left">
              <h1 className="text-[28px] sm:text-[32px] md:text-[36px] lg:text-[46px] font-bold leading-tight flex flex-col gap-2">
                {/* First row */}
                <div>
                  <span className="bg-gradient-to-r from-[#8371FF] via-[#A077FE] to-[#01C7E4] bg-clip-text text-transparent whitespace-nowrap">
                  Cozy and Cute   
                  </span>
                  <span className="text-[#161C2D] whitespace-nowrap"> AI-Generated</span>
                </div>
                
                {/* Second row */}
                <div>
                  <span className="text-[#161C2D] whitespace-nowrap">Everyday Onesie Portraits</span>
                </div>
              </h1>
          ...
          <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] w-full mt-9 lg:mt-0 lg:translate-x-12">
            <Image
              src="/cute.png"
