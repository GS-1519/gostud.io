      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center py-4 sm:py-6">
            ...
            <div className="max-w-[733px] text-center lg:text-left px-2 sm:px-0">
              <h1 className="text-[24px] sm:text-[28px] md:text-[36px] lg:text-[40px] font-bold leading-tight flex flex-col gap-0.5 sm:gap-1">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="text-[#161C2D]">AI-Generated Wednesday</span>
                </div>

                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="text-[#161C2D]">Addams-Inspired Portraits</span>
                </div>
              </h1>
          ...
          <div className="relative h-[250px] sm:h-[350px] md:h-[450px] lg:h-[600px] w-full mt-6 lg:mt-0 lg:translate-x-12">
            <Image
              src="/wed.png"
              alt="Wednesday Addams headshots"
              fill
