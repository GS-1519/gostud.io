            ...
            <div className="max-w-[733px] text-center lg:text-left px-2 sm:px-0">
              <h1 className="text-[24px] sm:text-[28px] md:text-[36px] lg:text-[40px] font-bold leading-tight flex flex-col gap-0.5 sm:gap-1">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start items-center">
                  <span className="text-[#161C2D] whitespace-nowrap">Bold and Personal </span>
                </div>
                
                {/* Line 2 */}
                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="bg-gradient-to-r from-[#8371FF] via-[#A077FE] to-[#01C7E4] bg-clip-text text-transparent whitespace-nowrap">AI-Generated Tattoo</span>
                </div>

                {/* Line 3 */}
                <div className="flex flex-wrap justify-center lg:justify-start">
                  <span className="text-[#161C2D]">-Inspired Headshots</span>
                </div>
              </h1>

              <p className="mt-4 sm:mt-6 text-base sm:text-lg text-[#4B5563] max-w-[600px] mx-auto lg:mx-0">
                Showcase your individuality with striking AI headshots that highlight your unique tattoos in bold, artistic detail.
              </p>
