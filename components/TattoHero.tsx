          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="max-w-[733px] text-center lg:text-left">
              <h1 className="text-[28px] sm:text-[32px] md:text-[36px] lg:text-[40px] font-bold leading-tight flex flex-col gap-2">
                {/* First row */}
                <div>
                  <span className="text-[#161C2D]">Bold and Personal </span>
                  <span className="bg-[#01C7E4] bg-clip-text text-transparent">AI-</span>
                </div>
                
                {/* Second row */}
                <div>
                  <span className="bg-gradient-to-r from-[#8371FF] via-[#A077FE] to-[#01C7E4] bg-clip-text text-transparent">Generated Tattoo</span>
                  <span className="text-[#161C2D]">-Inspired Headshots</span>
                </div>
              </h1>

              <p className="mt-6 text-[18px] text-[#4B5563]">
              Showcase your individuality with striking AI headshots that highlight your unique tattoos in bold, artistic detail.              </p>
