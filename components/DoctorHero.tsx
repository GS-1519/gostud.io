        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center py-8 sm:py-12">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="max-w-[733px] text-center lg:text-left">
              <h1 className="text-[40px] font-bold leading-[60.48px]">
                ...
                <div className="flex flex-wrap gap-x-2">
                  ...
                  <span>AI Headshots at your</span>
                </div>
                <div>
                  <span>Home</span>
                </div>
              ...
              Get more clients and increase your social presence with GoStudio.ai at home.              </p>
